        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-3"><strong>The Ai.team Limited</strong>, a company registered in England and Wales (Company Number: [NUMBER]), trading as "Squidgy", with registered office at [ADDRESS] ("we", "us", "our", "Squidgy", or "the Company")</p>
