...
/**
 * Platform icon utility functions
 * Provides real SVG logos for social media platforms
 */

export const getPlatformIcon = (platform: string, size: string = 'w-5 h-5') => {
...
export const getPlatformColor = (platform: string) => {
  switch (platform.toLowerCase()) {
    ...
    case 'instagram': return '#E91E63'; // More pinkish Instagram color
