...
// Import all pages
import SmmAssistantSmmAssistantAbc123SMMDashboardPage1 from './smm_assistant_abc123_smm_dashboard_page1';
import SmmAssistantSmmAssistantDef456AnalyticsViewPage2 from './smm_assistant_def456_analytics_view_page2';
import SmmAssistantSmmAssistantGhi789ContentCreatorPage3 from './smm_assistant_ghi789_content_creator_page3';
import SmmAssistantSmmAssistantLiquidBlanch17032840Page4 from './smm_assistant_liquid_blanch_17032840_page4';
import SmmAssistantSmmAssistantAnalyticsDemo12345Page5 from './smm_assistant_analytics_demo_12345_page5';
...
export default function SmmAssistantAgent() {
  return (
    <Routes>
      ...
      <Route path="smm-assistant-analytics-demo-12345-page5" element={<SmmAssistantSmmAssistantAnalyticsDemo12345Page5 />} />
    </Routes>
  );
}
...
export const agentConfig = {
  ...
  "pages": [
    ...
    {
      "name": "smm_assistant_analytics-demo-12345_page5",
      "path": "smm-assistant-analytics-demo-12345-page5"
    }
  ]
};
