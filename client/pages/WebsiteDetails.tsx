                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex flex-wrap gap-4">
                    ...
                    <a
                      ...
                      className="group relative block w-48 h-32 cursor-pointer overflow-hidden rounded-lg border-2 border-gray-200 shadow-sm hover:border-squidgy-purple transition-all"
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/0 transition-colors group-hover:bg-black/20 flex items-center justify-center">
                        <div className="opacity-0 group-hover:opacity-100 bg-white/95 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-sm transition-all transform scale-90 group-hover:scale-100 flex items-center gap-1.5">
                          <svg className="w-3.5 h-3.5 text-squidgy-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                          </svg>
                          <span className="text-xs font-bold text-squidgy-purple tracking-wide">BÜYÜT</span>
                        </div>
                      </div>
                    </a>
                    ...
                    {faviconUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative block w-16 h-16 cursor-pointer overflow-hidden rounded-lg border-2 border-gray-200 shadow-sm hover:border-squidgy-purple transition-all"
                        title="View logo"
                      >
                        <img
                          src={faviconUrl}
